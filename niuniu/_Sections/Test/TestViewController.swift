...
class TestViewController: BaseiNaviViewController, UINavigationControllerDelegate,  UIImagePickerControllerDelegate, QRCodeReaderViewControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        /*
        _ = GCDManager.delay(0.1, task: { () -> () in
